...
// ============================================================================
// Grouping Of Airports
// ============================================================================

export const SortAirportBySchema = z.enum(["country", "icao", "iata"]);
export type SortAirportBy = z.infer<typeof SortAirportBySchema>;

export const AIRPORT_SORTING_LABELS: Record<SortAirportBy, string> = {
...
export const DistanceUnitSchema = z.enum(["m", "ft", "nm"]);
