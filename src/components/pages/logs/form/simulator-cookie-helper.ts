import { SimulatorSessionForm } from "@/types/logs";

const DRAFT_COOKIE_NAME = "nplb_simulator_form_draft";
const DRAFT_COOKIE_MAX_AGE = 60 * 60 * 24 * 7; // 7 days

export function getDraftFromCookie(): SimulatorSessionForm | null {
...
export function saveDraftToCookie(data: SimulatorSessionForm) {
